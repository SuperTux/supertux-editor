...
#define MyAppVerName "SuperTux Editor 0.4.0"
#define MyAppMajVerName "SuperTux Editor 0.4"
...
begin
	...
	begin
		ResultSuperTux := MsgBox('{#MyAppVerName} requires SuperTux 0.4 to be installed. Are you sure you want to continue without installing SuperTux-0.3?',
		                         mbConfirmation, MB_YESNO) = idYes;
